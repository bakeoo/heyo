...
export default function WhatsAppFloat() {
  return (
    <ContactLink
      ...
      className="group fixed bottom-[calc(1.25rem+env(safe-area-inset-bottom,0px))] right-5 z-50 flex h-14 w-14 items-center justify-end overflow-hidden rounded-full bg-whatsapp text-white shadow-lg transition-all duration-300 hover:w-40 hover:bg-whatsappDark focus-visible:w-40"
    >
